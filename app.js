...
/** Zweig neben dem Kreis – botanische Linie statt Bildchen (UI-Wärme). */
const ZWEIG = `<svg class="eigenes-zweig" viewBox="0 0 90 70" aria-hidden="true"><path d="M86 38C62 36 34 42 6 60"/><path d="M30 47c-6-8-4-17 2-22 5 7 5 15-2 22zM44 43c-2-10 3-17 10-19 2 8-2 16-10 19zM58 40c1-9 8-14 15-14-1 8-7 13-15 14zM20 53c-9-3-13-10-11-17 8 2 12 9 11 17zM36 45c-8 4-17 2-21-4 7-4 15-3 21 4z"/></svg>`;
  ...
  return `<section class="eigenes" aria-labelledby="eigenes-titel">
      ...
      <div class="eigenes-rechts">
        <div class="eigenes-bild" aria-hidden="true">
          ...
          <span class="logo eigenes-gruss">Ich freue mich<br>auf deine Nachricht!</span>
          <svg class="eigenes-pfeil" viewBox="0 0 60 60"><path d="M40 4c10 16 6 34-12 46M28 50l-1-11M28 50l10-4"/><path class="eigenes-herz" d="M52 34c-2-3-7-2-6 2 1 3 6 6 6 6s5-3 6-6c1-4-4-5-6-2z"/></svg>
        </div>
