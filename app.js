...
/** WhatsApp-Zeichen (Glyphe von simple-icons, CC0) – unverändert, wie es die Markenregeln für „Kontakt per WhatsApp“ erlauben. */
const WA = `<svg class="wa-zeichen" viewBox="0 0 24 24" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413Z"/></svg>`;

/** Zweig mit Salbeiblättern, der hinter dem Kreis durchläuft (Entwurf des Nutzers 2026-09-23). */
const ZWEIG = `<svg class="eigenes-zweig" viewBox="0 0 240 170" aria-hidden="true"><defs><path id="e-blatt" d="M0 0C7-9 22-10 30 0C22 10 7 9 0 0Z"/></defs><path class="stiel" d="M10 34C60 44 96 70 120 86S190 124 230 132"/><use href="#e-blatt" class="t1" transform="translate(30 30) rotate(-35) scale(1.15)"/><use href="#e-blatt" class="t2" transform="translate(40 52) rotate(30) scale(1.0)"/><use href="#e-blatt" class="t1" transform="translate(58 44) rotate(-20) scale(1.2)"/><use href="#e-blatt" class="t2" transform="translate(66 66) rotate(40) scale(1.05)"/><use href="#e-blatt" class="t1" transform="translate(86 58) rotate(-10) scale(1.1)"/><use href="#e-blatt" class="t2" transform="translate(20 46) rotate(10) scale(0.9)"/><use href="#e-blatt" class="t1" transform="translate(168 118) rotate(25) scale(1.1)"/><use href="#e-blatt" class="t2" transform="translate(190 112) rotate(-30) scale(1.0)"/><use href="#e-blatt" class="t1" transform="translate(186 134) rotate(45) scale(1.05)"/><use href="#e-blatt" class="t2" transform="translate(206 126) rotate(5) scale(0.9)"/></svg>`;

/** „Etwas ganz Eigenes?" nach dem Entwurf des Nutzers vom 2026-09-23 – nur mit WhatsApp-Nummer. */
function eigenesHtml(link) {
  if (!link) return "";
  const haken = `<span class="eigenes-haken" aria-hidden="true">${ic("haken")}</span>`;
  return `<section class="eigenes" aria-labelledby="eigenes-titel">
      <div class="eigenes-links">
        <p class="eigenes-vorzeile">Persönliche Beratung</p>
        <h3 class="d" id="eigenes-titel">Etwas ganz Eigenes?</h3>
        <p class="eigenes-text">Für besondere Wünsche, größere Anlässe oder ein festes Budget mache ich dir gern ein eigenes Angebot.</p>
        <ul class="eigenes-punkte">
          <li>${haken}<span>Schnelle Antwort</span></li>
          <li>${haken}<span>Persönliche Beratung</span></li>
          <li>${haken}<span>Unverbindlich und kostenfrei</span></li>
        </ul>
      </div>
      <div class="eigenes-rechts">
        <div class="eigenes-bild" aria-hidden="true">
          ${ZWEIG}<span class="eigenes-kreis">${WA}</span>
          <span class="eigenes-gruss">Ich freue mich<br>auf deine Nachricht!</span>
          <svg class="eigenes-herz" viewBox="0 0 24 22"><path d="M12 20S2 13.5 2 7.5A4.8 4.8 0 0 1 12 5a4.8 4.8 0 0 1 10 2.5C22 13.5 12 20 12 20z"/></svg>
          <svg class="eigenes-pfeil" viewBox="0 0 70 80"><path d="M52 4C62 26 56 52 22 72M22 72l2-13M22 72l13-2"/></svg>
        </div>
        <a class="eigenes-knopf" href="${esc(link)}" target="_blank" rel="noopener">${WA}<span>Per WhatsApp schreiben</span>${ic("weiter")}</a>
        <p class="eigenes-hinweis">Einfach klicken und chatten – ganz unkompliziert.</p>
      </div>
    </section>`;
}
